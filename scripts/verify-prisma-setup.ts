...
async function verifySetup() {
  ...
  try {
    ...
    console.log('✅ Video created:', { id: testVideo.id, title: testVideo.title, status: testVideo.status });
    console.log();
    ...
    console.log('✅ Conversation created:', { id: testConversation.id, title: testConversation.title });
    console.log();
